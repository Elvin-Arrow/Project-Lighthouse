...
import { TerminalBackendCommandContribution} from './terminal-backend-contribution';

export default new ContainerModule(bind => {
    bind(CommandContribution).to(TerminalBackendCommandContribution).inSingletonScope();
