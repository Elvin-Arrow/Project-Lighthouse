        ...
        return <div id='widget-container'>
            ...
            <div className='sidebar'>
                <div className='links'>
                    <h2>Useful links</h2>
                    <ul>
                        <li><a href='//devdocs.io/python/'>Python documentation</a></li>
                        <li><a href='//devdocs.io/cpp/'>C++ documentation</a></li>
                    </ul>
                </div>
                <div>
                    <h2>Assignments</h2>
                    <button className='theia-button secondary' title='Attempt assignments' onClick={_a => this.attemptAssignments()}>Attempt assignments</button>
                </div>
            </div>
        </div>
    }

    private getTable(data: any): React.ReactNode {
        let rows = [];
