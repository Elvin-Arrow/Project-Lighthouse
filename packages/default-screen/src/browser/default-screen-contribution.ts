...
export const DefaultScreenCommand: Command = { id: 'default-screen:command', label: 'Default screen' };

@injectable()
export class DefaultScreenContribution extends AbstractViewContribution<DefaultScreenWidget> implements FrontendApplicationContribution {
